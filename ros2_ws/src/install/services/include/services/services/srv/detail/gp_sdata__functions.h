...
#ifndef SERVICES__SRV__DETAIL__GP_SDATA__FUNCTIONS_H_
#define SERVICES__SRV__DETAIL__GP_SDATA__FUNCTIONS_H_
...
/// Initialize srv/GPSdata message.
/**
...
/// Create srv/GPSdata message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * services__srv__GPSdata_Request__init().
...
/// Destroy srv/GPSdata message.
/**
 * It calls
 * services__srv__GPSdata_Request__fini()
...
/// Check for srv/GPSdata message equality.
/**
...
/// Initialize array of srv/GPSdata messages.
/**
...
/// Finalize array of srv/GPSdata messages.
/**
 * It calls
 * services__srv__GPSdata_Request__fini()
...
/// Create array of srv/GPSdata messages.
/**
 * It allocates the memory for the array and calls
 * services__srv__GPSdata_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GPSdata messages.
/**
 * It calls
 * services__srv__GPSdata_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GPSdata message array equality.
/**
...
/// Copy an array of srv/GPSdata messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * services__srv__GPSdata_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_services
...
/**
 * It calls
 * services__srv__GPSdata_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_services
...
/**
 * It allocates the memory for the array and calls
 * services__srv__GPSdata_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_services
...
/**
 * It calls
 * services__srv__GPSdata_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVICES__SRV__DETAIL__GP_SDATA__FUNCTIONS_H_
