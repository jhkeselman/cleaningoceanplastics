...
class KalmanService(Node):
    ...
    def calc_state(self):
        ...
        print(((self.Tl + self.Tr + drag_dir*DRAG*(self.state[2,0]**2))*math.cos(self.state[3,0])*self.dt**2)/(2*MASS), ((self.Tl + self.Tr + drag_dir*DRAG*(self.state[2,0]**2))*math.sin(self.state[3,0])*self.dt**2)/(2*MASS))
