...
class KalmanService(Node):
    ...
    def calc_state(self):
        ...
        G = np.array([[1,0,(math.cos(self.state[3])*self.dt - (self.dt**2)*DRAG*self.state[2]/MASS),(-self.state[2]*math.sin(self.state[3]) - (self.Tl + self.Tr - (DRAG*self.state[2]**2)*math.sin(self.state[3])*self.dt**2)/(2*MASS)),0],
                      [0,1,(math.sin(self.state[3])*self.dt - (self.dt**2)*DRAG*self.state[2]/MASS),(self.state[2]*math.cos(self.state[3]) + (self.Tl + self.Tr - (DRAG*self.state[2]**2)*math.cos(self.state[3])*self.dt**2)/(2*MASS)),0],
