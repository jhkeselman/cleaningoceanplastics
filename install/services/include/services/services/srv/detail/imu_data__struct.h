...
enum
{
  services__srv__IMUData_Event__request__MAX_SIZE = 1
};
// response
enum
{
  services__srv__IMUData_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/IMUData in the package services.
typedef struct services__srv__IMUData_Event
{
  service_msgs__msg__ServiceEventInfo info;
  services__srv__IMUData_Request__Sequence request;
  services__srv__IMUData_Response__Sequence response;
} services__srv__IMUData_Event;

// Struct for a sequence of services__srv__IMUData_Event.
typedef struct services__srv__IMUData_Event__Sequence
{
